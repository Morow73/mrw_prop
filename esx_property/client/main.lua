	      ...
	      table.insert(elements, {label = 'sortir votre véhicules', value = 'exit'})
		    ...
		    ESX.UI.Menu.Open(
			        ...
			        if data.current.value == 'enter' then
				        ...
				        if IsPedSittingInAnyVehicle(PlayerPedId()) then 
				            ...
				            if healthPercent < 15 then
				                ...
				                TriggerServerEvent('esx_property:setParking', plate, name, zone, vehicleProps)
			    ...
			    function(data, menu)
			        ...
			        CurrentActionMsg  = 'Appuie sur ~INPUT_CONTEXT~ pour acceder aux garage'
			        CurrentActionData = {property = property, owner = owner}
			    end
		    )
		end
	else 
        ESX.ShowNotification("Ce garage n'est pas le votre !")		
	end
end
